    ...
    <div className="flex">
      {previousPage && (
        <div className="flex flex-col items-start gap-3">
          <PageLink label="Poprzednie" page={previousPage} previous />
        </div>
      )}
      {nextPage && (
        <div className="ml-auto flex flex-col items-end gap-3">
          <PageLink label="Następne" page={nextPage} />
        </div>
      )}
    </div>
  )
  ...
  return (
    <div className="flex flex-col items-center justify-between gap-5 border-t border-zinc-900/5 pt-8 sm:flex-row dark:border-white/5">
      <p className="text-xs text-zinc-600 dark:text-zinc-400">
        Strona ma na celu być pomocą naukową dla rocznika 23/24. <br/ >
        &copy; Wartość intelektualna przedstawiona na stronie należy do naszej Pani dydaktyk.  Proszę tego nie nadużywać. 
      </p>
      <div className="flex gap-4">
        <SocialLink href="https://discord.gg/mzCCGSNF" icon={DiscordIcon}>
